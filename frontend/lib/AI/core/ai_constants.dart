...
abstract class TokenLimits {
  ...
  /// - 대운 상세, 자녀운, 귀인운, 가족관계, 타이밍 조언 추가
  /// - 4096 → 20000 → 30000 (v6.3 콘텐츠 대폭 추가)
  static const int sajuBaseMaxTokens = 30000;
...
abstract class PromptVersions {
  ...
  /// - V2.4 (2026-02-04): 쉬운말 원칙 추가 - 전문용어 본문 직접 사용 금지
  ///         "갑목 일간" → "큰 나무의 기운을 타고난 당신" 등 일상어 변환
  static const String dailyFortune = 'V2.4';
  ...
  /// - V5.5 (2026-02-04): 쉬운말 원칙 추가 - 오행/십성/합충 쉬운말 변환
  ///         "경금 일간" → "단단한 금속의 기운을 타고난 당신" 등 일상어 변환
  static const String yearlyFortune2026 = 'V5.5';
  ...
  /// - V3.5 (2026-02-04): 쉬운말 원칙 추가 - 일간별 화기운 영향 쉬운말 변환
  ///         "을목(乙木) 일간에게 화는 식상" → "유연한 나무 기운의 당신에게 표현의 에너지" 등
  static const String yearlyFortune2025 = 'V3.5';
