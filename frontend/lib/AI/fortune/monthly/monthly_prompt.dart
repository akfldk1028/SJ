...

{
  ...
  "career": {
    "title": "직업운",
    "score": 70,
    "reading": "이번달 직장에서는 ${_monthGanji}의 {십성} 기운이 흐르면서 {상황 분석}한 흐름입니다. 왜냐하면 {이름}님의 일간이 {일간}이시고, 이번달 월지의 ${_monthElement['branchElement']} 기운이 {십성}으로 작용하기 때문이에요. {십성}은 직장에서 {십성의 직장적 의미}를 의미하거든요. {이름}님의 원국에서 관성이 {관성 특성}하신 편이라, 이번달과 만나면서 {구체적 영향}이 예상됩니다. {합충이 있다면} 일지와 월지가 {합/충}하면서 {변화/안정}의 에너지도 더해지고요. 첫째 주에는 {1주차 특성}하고, 셋째 주가 {3주차 특성}한 시기예요. 업무 성과를 높이려면 {업무 조언}하시고, 동료/상사 관계에서는 {관계 조언}을 기억하세요. {마무리 조언}하시면 좋은 결과가 있을 거예요. (반드시 8-10문장, 왜 그런 영향인지 원인-결과가 자연스럽게 이어지도록)"
  },

  "wealth": {
    "title": "재물운",
    "score": 68,
    "reading": "재물 측면에서 이번달은 {십성}의 기운이 흐르면서 {재물 전반 흐름}한 흐름입니다. 이번달 ${_monthElement['branchElement']} 기운이 {이름}님에게 {십성}으로 작용하는데, 이 {십성}은 재물에서 {재물적 의미}를 나타내거든요. 그래서 {구체적 재물 영향}이 예상됩니다. {이름}님의 원국에서 재성이 {재성 강약}하신 편이라, {원국과의 상호작용}이 생기게 돼요. {비겁/인성 영향이 있다면} 이런 구조라서 {비겁/인성 구체적 영향}에 유의하시면 좋겠어요. 첫째-둘째 주에는 {1-2주차 재물 특성}하고, 셋째-넷째 주에는 {3-4주차 재물 특성}한 흐름이에요. 투자는 {투자 조언}하시고, 지출 관리는 {지출 조언}을 권해드려요. {마무리 조언}하시면 안정적으로 한 달을 보내실 수 있을 거예요. (반드시 8-10문장, 왜 그런 영향인지 원인-결과가 자연스럽게 이어지도록)"
  },

  "love": {
    "title": "애정운",
    "score": 72,
    "reading": "애정운에서 이번달은 월지와 일지의 관계로 {연애 전반 분위기}한 기운이 흐릅니다. 이번달 월지 ${_monthElement['branch']}가 {이름}님의 일지 {일지}와 {합/충/무관계}하는데, 이게 연애에 {합충 영향}을 의미해요. {합이면} 합은 인연의 문을 여는 에너지라 {합 구체적 영향}이 있고, {충이면} 충은 변화의 에너지라 {충 구체적 영향}이 생길 수 있어요. {이름}님의 원국에서 {배우자성}이 {특성}하신 편이라, 이번달 {연애 구체적 영향}이 예상됩니다. {도화살이 있다면} 이번달 도화 기운도 작용해서 {도화 영향}도 있고요. 솔로이신 분들은 {솔로 조언}하시면 인연을 만날 수 있어요. 연인이 있으신 분들은 {커플 조언}에 신경 쓰시면 관계가 더 좋아질 거예요. (반드시 8-10문장, 왜 그런 영향인지 원인-결과가 자연스럽게 이어지도록)"
  },

  "health": {
    "title": "건강운",
    "score": 65,
    "reading": "건강 측면에서 이번달은 ${_monthElement['branchElement']} 기운이 강하게 흐르면서 {건강 전반 분위기}에 주의가 필요합니다. 왜냐하면 이번달 ${_monthElement['branchElement']}이 {이름}님에게 {십성}으로 작용하는데, 오행에서 이 기운은 {해당 장부}에 해당하거든요. 그래서 {건강 영향 원인}이 생길 수 있어요. {이름}님의 원국에서 {약한 오행}이 약한 편이시라, 이번달과 만나면서 {오행 불균형}이 나타날 수 있습니다. 특히 {관련 장부/부위}에 신경 쓰시면 좋겠어요. 둘째-셋째 주에 {2-3주 건강 특성}에 주의하시고, 운동으로는 {운동 추천}을 권해드려요. 식이요법은 {음식 조언}이 도움되고, 충분한 휴식과 {라이프스타일 조언}으로 건강하게 한 달 보내실 수 있을 거예요. (반드시 8-10문장, 왜 그런 영향인지 원인-결과가 자연스럽게 이어지도록)"
  },
