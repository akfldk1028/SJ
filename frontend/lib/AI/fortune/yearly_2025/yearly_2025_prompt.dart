...
**매우 중요**: 각 회고에서 "고전에서는 ~했지만, 현대에서는 ~로 해석됩니다" 형식을 자연스럽게 포함하세요!
...
**회고 시 설명 예시:**
- "고전에서 식상은 자녀를 잘 기른다고 해석했지만, 현대에서는 유튜브/블로그 같은 1인 미디어에서 빛나는 재능입니다. 지난해 식상 기운을 받으셨다면 콘텐츠 창작이나 SNS 활동에서 성과가 있으셨을 거예요."
- "고전에서 역마살은 타향에서 고생한다고 봤지만, AI시대에는 디지털노마드나 해외 원격근무로 오히려 기회가 됩니다. 지난해 역마 기운을 받으셨다면 새로운 환경에서의 도전이 있으셨을 수 있어요."
- "고전에서 관살은 벼슬에 나간다고 해석했지만, 현대에서는 직장에서의 승진이나 책임 증가로 나타납니다. 힘드셨지만 그만큼 성장하신 한 해였을 거예요."
...
- "특히 {이름}님의 용신이 {용신}이시라, 화와 {상생/상극} 관계라서..."
...

{
  ...
  "categories": {
    "career": {
      ...
      "icon": "💼",
      "score": 70,
      "reading": "2025년 직장에서 {일간} 일간에게 을사(乙巳)의 화(火)는 **{십성}**으로 작용했어요. {십성}은 직장에서 {십성의 직장적 의미}를 나타내거든요. 그래서 지난해 직장에서 {구체적 영향}을 경험하셨을 가능성이 높습니다. {용신과의 관계: 예) 용신이 토인데 화생토로 용신을 도와 상사/귀인 운이...}. 또한 일지 {일지}와 세운 사(巳)가 {합/충 분석: 예) 사신합이라 좋은 협력이...}. 원국에서 관성이 {관성 강약}하신 편이라 {관성 영향}을 느끼셨을 거예요. 상반기에는 {상반기 회고}, 하반기에는 {하반기 회고}했을 것 같습니다. 이 경험이 2026년 {연결 조언}에 도움이 될 거예요. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    },
    "business": {
      "title": "사업운 회고",
      "icon": "🏢",
      "score": 68,
      "reading": "사업 측면에서 {일간} 일간에게 2025년 화(火)는 **{십성}**이에요. {십성}은 사업에서 {십성의 사업적 의미}를 나타내거든요. 그래서 지난해 사업운은 {구체적 영향}을 경험하셨을 가능성이 높습니다. 원국에서 재성이 {재성 강약}하신 편이라, 화 기운과 만나면서 {재성과 화의 관계: 예) 화생토로 재성이 힘을 얻어 매출이...}. 파트너십 측면에서는 일지와 巳의 {합/충 분석: 예) 사신합이라 좋은 협력이...}. 어려움이 있었다면 {기신 분석: 예) 기신 수가 화에 극당해...}이 작용했을 수 있어요. 이 경험이 2026년 {연결 조언}에 도움이 될 거예요. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    },
    "wealth": {
      "title": "재물운 회고",
      "icon": "💰",
      "score": 65,
      "reading": "재물 측면에서 {일간} 일간에게 2025년 화(火)가 **{십성}**으로 작용했어요. {십성}은 재물에서 {십성의 재물적 의미}를 나타내거든요. 원국에서 재성이 {재성 강약}하시고, 화와 재성의 관계가 {상생/상극: 예) 화생토로 재성을 생하면 수입 기회가...}. 그래서 지난해 재물에서 {구체적 영향}을 경험하셨을 가능성이 있습니다. 비겁과의 관계도 {비겁 분석: 예) 비겁이 강한데 화가 비겁을 생하면 경쟁/지출이...}. 수입은 {수입 회고}, 지출은 {지출 회고}한 패턴이었을 거예요. 이 교훈이 2026년 재물 관리에 {연결 조언}될 겁니다. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    },
    "love": {
      "title": "연애운 회고",
      "icon": "💕",
      "score": 72,
      "reading": "연애 측면에서 일지 {일지}와 세운 사(巳)의 관계가 핵심이에요. {합/충 분석: 예) 사신합이라 좋은 인연이... 또는 사해충이라 관계 변화가...}. {일간} 일간에게 화(火)가 **{십성}**인데, {십성}은 연애에서 {십성의 연애적 의미}를 나타내요. 그래서 지난해 연애에서 {구체적 영향}을 경험하셨을 가능성이 높습니다. 원국의 배우자성이 {배우자성 분석}하신 편이라, {배우자성 영향}도 있었을 거예요. {도화살 분석이 있다면} 도화 기운도 작용해서 {도화 영향}. 이 경험이 2026년 인연에 {연결 조언}될 겁니다. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    },
    "marriage": {
      "title": "결혼운 회고",
      "icon": "💍",
      "score": 68,
      "reading": "결혼 측면에서 배우자궁인 일지 {일지}와 세운 사(巳)의 관계가 가장 중요해요. {합/충 분석: 예) 사신합이면 결혼운 좋았을... 사해충이면 부부관계 변화...}. {일간} 일간에게 화(火)가 **{십성}**인데, 결혼에서 {십성}은 {십성의 결혼적 의미}를 나타내요. 원국의 배우자성이 {배우자성 강약}하신 편이라, 지난해 {구체적 영향}을 경험하셨을 가능성이 있습니다. 미혼이셨다면 {미혼 회고}, 기혼이셨다면 {기혼 회고}한 흐름이었을 거예요. 이 경험이 2026년 가정에 {연결 조언}될 겁니다. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    },
    "study": {
      "title": "학업운 회고",
      "icon": "📚",
      "score": 75,
      "reading": "학업 측면에서 {일간} 일간에게 2025년 화(火)가 **{십성}**으로 작용했어요. {십성}은 학업에서 {십성의 학업적 의미}를 나타내요. 인성이라면 '흡수하는 힘', 식상이라면 '표현하는 힘'이거든요. 원국에서 인성이 {인성 강약}하시고 식상이 {식상 강약}하신 편이라, 지난해 학업에서 {구체적 영향}을 경험하셨을 가능성이 높습니다. 화 기운이 {인성/식상과의 관계: 예) 화가 인성을 생해서 학습 흡수력이...}. 시험운은 {시험 회고}, 집중력은 {집중력 회고}한 흐름이었을 거예요. 이 경험이 2026년 학업에 {연결 조언}될 겁니다. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    },
    "health": {
      "title": "건강운 회고",
      "icon": "🏥",
      "score": 65,
      "reading": "건강 측면에서 2025년 을사(乙巳)는 **목(木)과 화(火)** 기운이 강했어요. 오행에서 목은 **간/담/근육**, 화는 **심장/소장/눈**에 해당합니다. {일간} 일간에게 화(火)가 **{십성}**인데, {십성}은 건강에서 {십성의 건강적 의미}를 나타내요. 원국에서 {약한 오행}이 약하신 편이라, 화 기운과 만나면서 {오행 불균형: 예) 금이 약한데 화가 강해 화극금으로 폐/호흡기가...}. 그래서 지난해 {구체적 영향}을 경험하셨을 가능성이 있습니다. 특히 {주의 시기}에 {증상 회고}가 있었을 수 있어요. 이 경험으로 2026년에는 {연결 조언}하시면 좋겠어요. (반드시 12-15문장, 왜 그런 영향이었는지 명리학적 원인-결과로!)"
    }
  },
