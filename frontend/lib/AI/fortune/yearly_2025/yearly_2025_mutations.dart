...
class Yearly2025Mutations {
  ...
  Future<Map<String, dynamic>> save({
    ...
    try {
      ...
      // partial unique index (idx_ai_summaries_unique_yearly_2025)가 중복 방지
      await _supabase
          .from('ai_summaries')
          .delete()
      ...
      if (e.code == '23505') {
        print('[Yearly2025Mutations] ⚠️ 중복 키 충돌 → 재시도');
        await _supabase
            .from('ai_summaries')
            .delete()
            .eq('profile_id', profileId)
        ...
        print('[Yearly2025Mutations] ✅ DB 재시도 저장 성공: ${response['id']}');
        return response;
      }
