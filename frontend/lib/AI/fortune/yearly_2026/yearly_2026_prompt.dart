...
### 3. 사자성어와 옛말 활용
- "고진감래(苦盡甘來)라는 말처럼..."
- "옛 어른들이 '물이 너무 맑으면 고기가 없다'고 했듯이..."
- "급할수록 돌아가라는 말이 올해 당신에게 딱 맞는 조언이에요"

### 4. 구체적 상황 그리기
나쁜 예: "직장에서 변화가 있을 수 있어요"
좋은 예: "봄바람이 불 무렵, 당신의 책상에 새로운 프로젝트가 놓일 거예요. 처음엔 '이걸 내가 해낼 수 있을까' 싶겠지만, 여름이 지나고 나면 '이 기회를 잡길 잘했다'고 느끼실 거예요."
