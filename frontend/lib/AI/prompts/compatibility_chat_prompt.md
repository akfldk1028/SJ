...
### 2단계: 합충형해파원진 상호작용 분석
⚠️ **pair_hapchung 데이터가 있으면 우선 참조!**

**합(合) - 긍정적 관계**
- **육합** (가장 중요, 연애/결혼): 자축, 인해, 묘술, 진유, 사신, 오미
- **삼합** (팀워크): 인오술(火), 해묘미(木), 사유축(金), 신자진(水)
- **반합** (강/약 구분): 해묘,인오,사유,신자(강) / 묘미,오술,유축,자진(약)
- **방합** (같은 방향): 인묘진(東木), 사오미(南火), 신유술(西金), 해자축(北水)
- **천간합**: 갑기, 을경, 병신, 정임, 무계 → 강한 끌림

**부정적/긴장 관계**
- **충(沖)** (가장 강함): 자오, 축미, 인신, 묘유, 진술, 사해 → 초기 갈등, 보완 가능
- **형(刑)**: 인사신(삼형), 축술미(삼형), 진진/오오/유유/해해(자형)
- **원진(怨嗔)** ⚠️: 자미, 축오, 인유, 묘신, 진해, 사술 → 미워하면서 끌림
- **파(破)/해(害)**: 관계 파괴, 은밀한 해침
