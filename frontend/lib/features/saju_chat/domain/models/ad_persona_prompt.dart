...
''',
  ...
  static String getCtaText(AiPersona persona, AdTriggerResult trigger) {
    ...
    if (trigger == AdTriggerResult.intervalAd) {
      final variants = switch (personaName) {
        'doryeong' || 'dolyeong' => [
          '광고를 확인하시면 AI와 더 대화할 수 있사옵니다!',
          '이것을 살펴주시면 이야기를 더 이어갈 수 있구려.',
          '한번 살펴보시면 대화의 깊이가 더해지리다.',
          '확인하시면 더 좋은 이야기를 들려드리겠소.',
        ],
        'seonyeo' || 'sunnyeo' => [
          '광고를 확인하시면 저와 더 대화할 수 있어요!',
          '살짝 살펴보시면 더 깊은 이야기를 나눌 수 있어요.',
          '확인하시면 인연의 이야기가 계속돼요.',
          '살펴주시면 더 재미있는 얘기 해드릴게요!',
        ],
        'monk' || 'seunim' => [
          '광고를 확인하시면 대화를 더 이어갈 수 있습니다.',
          '살펴보시면 법문을 계속 이어가겠습니다.',
          '한번 확인해보시오, 좋은 공덕이 되리다.',
          '살펴보시면 이야기를 더 나눌 수 있사옵니다.',
        ],
        'grandmother' || 'halmeoni' => [
          '이거 확인하면 얘기 더 할 수 있어!',
          '한번 살펴봐, 더 얘기해줄게!',
        ...
        _ => [
          '광고를 확인하면 AI와 더 대화할 수 있어요!',
          '살펴보시면 대화를 더 이어갈 수 있어요!',
          '한번 확인해보시면 더 많은 이야기를 나눌 수 있어요.',
          '확인하시면 대화가 계속돼요!',
        ],
      };
      return variants[_random.nextInt(variants.length)];
