...
/// DB의 profile_type 컬럼에 매핑
 ...
 String? get memo;/// UI/AI 응답 언어 (ko, ja, en)
...
@useResult
$Res call({
 String id, String displayName, Gender gender, DateTime birthDate, bool isLunar, bool isLeapMonth, int? birthTimeMinutes, bool birthTimeUnknown, bool useYaJasi, String birthCity, int timeCorrection, DateTime createdAt, DateTime updatedAt, bool isActive, RelationshipType relationType, String profileType, String? memo, String locale
});
