...
/// 2024-01-04 전체 재생성
final List<LunarYearData> lunarTable1950_1999 = [
  // 1950년
  LunarYearData(
    year: 1950,
    leapMonth: 0,
  ...
  LunarYearData(
    year: 1953,
    leapMonth: 0,
    monthDays: [29, 30, 29, 29, 30, 30, 29, 30, 30, 29, 30, 30],
  ...
  LunarYearData(
    ...
    solarNewYear: DateTime(1954, 2, 4),
  ),
  // 1955년 - 윤3월
  LunarYearData(
    year: 1955,
  ...
  LunarYearData(
    ...
    solarNewYear: DateTime(1958, 2, 19),
  ),
  // 1959년
  LunarYearData(
    year: 1959,
  ...
  LunarYearData(
    ...
    solarNewYear: DateTime(1966, 1, 22),
  ),
  // 1967년
  LunarYearData(
    year: 1967,
  ...
  LunarYearData(
    year: 1976,
    leapMonth: 8,
    monthDays: [30, 30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 29, 30],
  ...
  LunarYearData(
    year: 1977,
    leapMonth: 0,
    monthDays: [30, 29, 30, 30, 29, 30, 29, 30, 29, 30, 29, 29],
  ...
  LunarYearData(
    year: 1985,
    leapMonth: 0,
    monthDays: [29, 30, 30, 29, 30, 29, 30, 29, 29, 30, 29, 30],
  ...
  LunarYearData(
    ...
    solarNewYear: DateTime(1988, 2, 18),
  ),
  // 1989년
  LunarYearData(
    year: 1989,
  ...
  LunarYearData(
    year: 1992,
    leapMonth: 0,
    monthDays: [29, 30, 30, 29, 29, 30, 29, 29, 30, 29, 30, 30],
  ...
  LunarYearData(
    year: 1993,
    leapMonth: 3,
    monthDays: [29, 30, 30, 29, 30, 29, 30, 29, 29, 30, 29, 30, 29],
  ...
  LunarYearData(
    ...
    leapMonth: 0,
    monthDays: [29, 29, 30, 29, 30, 29, 30, 30, 29, 30, 30, 29],
    solarNewYear: DateTime(1997, 2, 8),
  ),
  // 1998년 - 윤5월
  LunarYearData(
    year: 1998,
    leapMonth: 5,
    monthDays: [30, 29, 29, 30, 29, 29, 30, 30, 29, 30, 30, 30, 29],
