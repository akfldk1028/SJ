...
const Map<String, Map<String, String>> _pillarNameI18n = {
  '년주': {'ko': '년주', 'en': 'Year', 'ja': '年柱', 'zh': '年柱',
    'vi': 'Năm', 'th': 'ปี', 'id': 'Tahun', 'ms': 'Tahun',
    'fr': 'Année', 'de': 'Jahr', 'es': 'Año', 'pt': 'Ano',
    'it': 'Anno', 'hi': 'वर्ष', 'ar': 'السنة', 'ru': 'Год', 'my': 'နှစ်'},
  '월주': {'ko': '월주', 'en': 'Month', 'ja': '月柱', 'zh': '月柱',
    'vi': 'Tháng', 'th': 'เดือน', 'id': 'Bulan', 'ms': 'Bulan',
    'fr': 'Mois', 'de': 'Monat', 'es': 'Mes', 'pt': 'Mês',
    'it': 'Mese', 'hi': 'माह', 'ar': 'الشهر', 'ru': 'Месяц', 'my': 'လ'},
  '일주': {'ko': '일주', 'en': 'Day', 'ja': '日柱', 'zh': '日柱',
    'vi': 'Ngày', 'th': 'วัน', 'id': 'Hari', 'ms': 'Hari',
    'fr': 'Jour', 'de': 'Tag', 'es': 'Día', 'pt': 'Dia',
    'it': 'Giorno', 'hi': 'दिन', 'ar': 'اليوم', 'ru': 'День', 'my': 'နေ့'},
  '시주': {'ko': '시주', 'en': 'Hour', 'ja': '時柱', 'zh': '时柱',
    'vi': 'Giờ', 'th': 'ชั่วโมง', 'id': 'Jam', 'ms': 'Jam',
    'fr': 'Heure', 'de': 'Stunde', 'es': 'Hora', 'pt': 'Hora',
    'it': 'Ora', 'hi': 'घंटा', 'ar': 'الساعة', 'ru': 'Час', 'my': 'နာရီ'},
  '년지': {'ko': '년지', 'en': 'Year', 'ja': '年支', 'zh': '年支',
    'vi': 'Năm', 'th': 'ปี', 'id': 'Tahun', 'ms': 'Tahun',
    'fr': 'Année', 'de': 'Jahr', 'es': 'Año', 'pt': 'Ano',
    'it': 'Anno', 'hi': 'वर्ष', 'ar': 'السنة', 'ru': 'Год', 'my': 'နှစ်'},
  '월지': {'ko': '월지', 'en': 'Month', 'ja': '月支', 'zh': '月支',
    'vi': 'Tháng', 'th': 'เดือน', 'id': 'Bulan', 'ms': 'Bulan',
    'fr': 'Mois', 'de': 'Monat', 'es': 'Mes', 'pt': 'Mês',
    'it': 'Mese', 'hi': 'माह', 'ar': 'الشهر', 'ru': 'Месяц', 'my': 'လ'},
  '일지': {'ko': '일지', 'en': 'Day', 'ja': '日支', 'zh': '日支',
    'vi': 'Ngày', 'th': 'วัน', 'id': 'Hari', 'ms': 'Hari',
    'fr': 'Jour', 'de': 'Tag', 'es': 'Día', 'pt': 'Dia',
    'it': 'Giorno', 'hi': 'दिन', 'ar': 'اليوم', 'ru': 'День', 'my': 'နေ့'},
  '시지': {'ko': '시지', 'en': 'Hour', 'ja': '時支', 'zh': '时支',
    'vi': 'Giờ', 'th': 'ชั่วโมง', 'id': 'Jam', 'ms': 'Jam',
    'fr': 'Heure', 'de': 'Stunde', 'es': 'Hora', 'pt': 'Hora',
    'it': 'Ora', 'hi': 'घंटा', 'ar': 'الساعة', 'ru': 'Час', 'my': 'နာရီ'},
};
