...
**구현 완료:**
- [x] 2020-2030년 절기 테이블 (한국천문연구원 데이터)
  - 2020-2026년: 공식 데이터 (https://holidays.dist.be)
  - 2027-2030년: 천문학적 근사 계산값 (오차 ±30분)
- [x] 24개 절기 × 11년 = 264개 절기 시각 포함
- [x] 소한/대한 추가 (기존에 누락됨)
