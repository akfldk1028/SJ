...
const birthYearCheongan = ["경", "신", "임", "계", "갑", "을", "병", "정", "무", "기"] as const;
...
const elementByCheongan: Record<string, ElementInfo> = {
  ...
  정: {
    ...
    eumYang: "음",
    modifier: "따뜻하게 비추고 오래 이어가는 힘이 강합니다.",
  },
  무: {
    elementName: "토",
    elementNameEn: "Earth",
  ...
  기: {
    ...
    eumYang: "음",
    modifier: "흩어진 것을 담고 조율하는 힘이 강합니다.",
  },
  경: {
    elementName: "금",
    elementNameEn: "Metal",
  ...
  신: {
    ...
    eumYang: "음",
    modifier: "정교한 감각, 완성도를 높이는 힘이 강합니다.",
  },
  임: {
    elementName: "수",
    elementNameEn: "Water",
...
const animalByJiji: Record<string, AnimalInfo> = {
  자: {
    ...
    animalEmoji: "🐭",
    title: "빠른 감각의 전략가",
    tone: "정보를 빠르게 읽고 기회를 놓치지 않는 타입",
    summary: "새로운 흐름을 먼저 보고, 복잡한 상황에서도 길을 찾습니다.",
    keywords: ["관찰력", "속도", "기회"],
  ...
  축: {
    ...
    animalEmoji: "🐮",
    title: "꾸준히 쌓는 완성형",
    tone: "느려 보여도 끝까지 바닥을 다지는 타입",
    summary: "작은 반복으로 성과를 만드는 힘이 강합니다.",
    keywords: ["지속력", "책임감", "안정"],
  ...
  묘: {
    ...
    summary: "부드럽게 스며들고, 갈등을 크게 만들지 않는 장점이 있습니다.",
    keywords: ["공감", "균형", "감각"],
    advice: "오늘은 무리하게 맞추기보다 내 기준을 문장으로 정리하세요.",
  },
  진: {
  ...
  사: {
    ...
    summary: "말하지 않아도 판단은 날카롭고, 선택의 질이 높습니다.",
    keywords: ["통찰", "집중", "선택"],
  ...
  오: {
    ...
    animalEmoji: "🐴",
    title: "흐름을 만드는 선동가",
    tone: "멈춰 있으면 에너지가 쌓이는 타입",
    summary: "움직이면서 생각을 정리하고, 사람을 끌어당기는 활력이 있습니다.",
    keywords: ["활력", "자유", "속도"],
  ...
  미: {
    ...
    summary: "사람과 공간의 결을 살피며 자연스러운 형태로 다듬습니다.",
    keywords: ["감성", "배려", "창의"],
    advice: "오늘은 결과보다 과정의 질을 높이면 좋은 반응이 따릅니다.",
  },
  신: {
    ...
    animalEmoji: "🐵",
    title: "문제를 푸는 실험가",
    tone: "답이 없을수록 재미를 느끼는 타입",
    summary: "아이디어가 빠르고 여러 방법을 실험하며 길을 찾습니다.",
    keywords: ["재치", "실험", "적응"],
  ...
  유: {
    ...
    summary: "기준과 디테일을 세워 일이 흐트러지지 않게 만듭니다.",
    keywords: ["정확함", "정돈", "표현"],
    advice: "오늘은 기준을 더 추가하기보다 우선순위를 줄이는 쪽이 좋습니다.",
  },
  술: {
  ...
  해: {
    ...
    animalEmoji: "🐷",
    title: "여유를 만드는 현실가",
    tone: "편안한 속에서 지속력을 채우는 타입",
    summary: "사람을 편하게 만들고 복잡한 일을 현실적으로 받아들입니다.",
    keywords: ["여유", "지속", "친화"],
