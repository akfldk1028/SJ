...
const JI_OHENG: Record<string, { oheng: string; yinyang: string }> = {
...
const 相生: Record<string, string> = { '목': '화', '화': '토', '토': '금', '금': '수', '수': '목' };
const 相克: Record<string, string> = { '목': '토', '토': '수', '수': '화', '화': '금', '금': '목' };
const 被生: Record<string, string> = { '목': '수', '화': '목', '토': '화', '금': '토', '수': '금' };
const 被克: Record<string, string> = { '목': '금', '화': '수', '토': '목', '금': '화', '수': '토' };

export function getSipsin(ilgan: string, target: string): Record<string, string> {
